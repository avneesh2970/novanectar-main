      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center">
            <Link href="/blog-admin/dashboard" className="text-purple-600 hover:text-purple-800 mr-4">
        ...
        {previewMode ? (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-4">{title || "Post Title"}</h1>
              <p className="text-gray-600 mb-4">{excerpt || "Post excerpt will appear here..."}</p>
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((category, index) => (
                  <span key={index} className="text-sm px-3 py-1 bg-purple-100 text-purple-800 rounded-full">
                    {category}
                  </span>
                ))}
                {categories.length === 0 && <span className="text-sm text-gray-400">No categories added</span>}
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-1 text-xs text-gray-500">URL-friendly version of the title (e.g., my-blog-post)</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                  ></textarea>
                  <p className="mt-1 text-xs text-gray-500">A brief summary of the post (displayed in blog listings)</p>
                </div>
