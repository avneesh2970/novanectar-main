    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            We&apos;re working on bringing you amazing events. Stay tuned for
            updates!
          </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 font-medium">Soon</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 font-medium">Exciting</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
