    ...
    >
      <div className="max-w-7xl mx-auto bg-[#FFFFFF] px-8 py-16 rounded-3xl">
        ...
        <div className="mt-4">
          <Link
            href="/about-us"
            className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold shadow hover:bg-blue-700 hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            See More
          </Link>
        </div>
