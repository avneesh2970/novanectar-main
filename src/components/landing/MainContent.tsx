    ...
    <>
      <div id="home-section">
        ...
        <div className="relative w-full bg-white pt-16">
          ...
          {/* Hover effect layer */}
          <div
            className="-mt-4 absolute inset-0 z-0 dark:bg-grid-hover-white/[0.4] sm:bg-grid-hover-black/[0.4] opacity-0 transition-opacity duration-300"
            id="grid-hover-layer"
          />
          ...
          {isClient ? (
            <>
                ...
                fallback={
                  <div className="h-[34rem] md:h-[40rem] flex flex-col items-center justify-center -mt-2">
                    ...
                    <div className="flex pt-10 px-2 justify-center gap-4">
                      <button
                        className={`bg-blue-700 px-3 py-2 sm:px-5 sm:py-2 text-white text-xs sm:text-base rounded-md font-medium ${DMSans.className}`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      <button
                        className={`border border-blue-700 text-blue-700 px-3 py-3 sm:px-5 sm:py-3 text-xs sm:text-base rounded-md font-medium ${DMSans.className}`}
              ...
              >
                {/* ✅ ONLY HERO CONTENT (NO FloatingTechLayout) */}
